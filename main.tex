...
% Verification tags: \P{...} = formal proof (Lean), \N{...} = numerical check,
% \Hyp{...} = hypothesis from literature, \Conj = proposed, \Open = open question.
% Block form: right-aligned on own paragraph (for end of theorem/remark).
% Inline form: just use the command mid-sentence.
% Note: \P overrides the pilcrow sign but the paper never uses it.
\newcommand{\P}[1]{{\footnotesize\textbf{P[#1]}}}
\newcommand{\N}[1]{{\footnotesize\textbf{N[#1]}}}
