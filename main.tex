...
% \Lean: always starts its own paragraph, right-aligned with word-wrap.
% \raggedleft right-aligns but allows line breaks (unlike \hfill which overflows).
\newcommand{\Lean}[1]{\par\noindent\raggedleft{\small\texttt{[#1]}}\par}
