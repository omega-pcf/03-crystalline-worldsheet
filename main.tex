...
% Uses \unskip\hfill for inline context (after \end{equation} or mid-text).
% Long lists word-wrap thanks to the emergency stretch and tolerance settings.
\newcommand{\Lean}[1]{\unskip\hskip 0pt plus 1fill\penalty0\relax
  \emergencystretch=4em\tolerance=9999\hbadness=10000\relax
  {\small\texttt{[#1]}}}
