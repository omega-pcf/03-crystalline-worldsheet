...
% Verification tag colors
\definecolor{tagP}{rgb}{0.15,0.35,0.65}  % dark blue — formal proof
\definecolor{tagN}{rgb}{0.15,0.55,0.25}  % dark green — numerical check
\definecolor{tagH}{rgb}{0.70,0.25,0.10}  % dark red — hypothesis
...
% Verification witness tags — descriptive names, consistent formatting.
% Inline form (mid-sentence):
\newcommand{\ProofWitness}[1]{{\mbox{\footnotesize\textcolor{tagP}{\textbf{P}}\texttt{[#1]}}}}
\newcommand{\NumericalWitness}[1]{{\mbox{\footnotesize\textcolor{tagN}{\textbf{N}}\texttt{[#1]}}}}
\newcommand{\HypWitness}[1]{{\mbox{\footnotesize\textcolor{tagH}{\textbf{H}}\texttt{[#1]}}}}
% Block form (end of theorem/remark, right-aligned, word-wrapping):
\newcommand{\ProofWitnessBlock}[1]{\par\noindent\hfill\parbox{\dimexpr\linewidth-1em}{\raggedleft\footnotesize\textcolor{tagP}{\textbf{P}}\texttt{[#1]}}\par}
\newcommand{\NumericalWitnessBlock}[1]{\par\noindent\hfill\parbox{\dimexpr\linewidth-1em}{\raggedleft\footnotesize\textcolor{tagN}{\textbf{N}}\texttt{[#1]}}\par}
\newcommand{\HypWitnessBlock}[1]{\par\noindent\hfill\parbox{\dimexpr\linewidth-1em}{\raggedleft\footnotesize\textcolor{tagH}{\textbf{H}}\texttt{[#1]}}\par}
\newcommand{\Conj}{{\footnotesize\textcolor{tagH}{\textbf{C}}}}
\newcommand{\Open}{{\footnotesize\textbf{O}}}
\newcommand{\Empty}{{\footnotesize\textbf{$\varnothing$}}}
% Legacy (used once, in status section):
