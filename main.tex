...
% Verification tags — consistent formatting: color letter + monospace content.
% Inline form (mid-sentence):
\newcommand{\Proof}[1]{{\footnotesize\textcolor{tagP}{\textbf{P}}\texttt{[#1]}}}
\newcommand{\Numeric}[1]{{\footnotesize\textcolor{tagN}{\textbf{N}}\texttt{[#1]}}}
\newcommand{\Hyp}[1]{{\footnotesize\textcolor{tagH}{\textbf{H}}\texttt{[#1]}}}
% Block form (end of theorem/remark, right-aligned, word-wrapping, no \par):
\newcommand{\ProofBlock}[1]{{\hfill\footnotesize\textcolor{tagP}{\textbf{P}}\texttt{[#1]}}}
\newcommand{\NumericBlock}[1]{{\hfill\footnotesize\textcolor{tagN}{\textbf{N}}\texttt{[#1]}}}
\newcommand{\HypBlock}[1]{{\hfill\footnotesize\textcolor{tagH}{\textbf{H}}\texttt{[#1]}}}
