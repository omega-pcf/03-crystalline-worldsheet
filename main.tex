...
% Verification tags — inline form (mid-sentence):
\newcommand{\Proof}[1]{{\footnotesize\textbf{P[#1]}}}
\newcommand{\Numeric}[1]{{\footnotesize\textbf{N[#1]}}}
\newcommand{\Hyp}[1]{{\footnotesize\textbf{H[#1]}}}
% Block form (end of theorem/remark, right-aligned, word-wrapping):
\newcommand{\ProofBlock}[1]{\par\noindent\hfill\parbox{\dimexpr\linewidth-1em}{\raggedleft\footnotesize\textbf{P[#1]}}\par}
\newcommand{\NumericBlock}[1]{\par\noindent\hfill\parbox{\dimexpr\linewidth-1em}{\raggedleft\footnotesize\textbf{N[#1]}}\par}
\newcommand{\HypBlock}[1]{\par\noindent\hfill\parbox{\dimexpr\linewidth-1em}{\raggedleft\footnotesize\textbf{H[#1]}}\par}
\newcommand{\Conj}{{\footnotesize\textbf{C}}}
