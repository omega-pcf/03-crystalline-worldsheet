...
\end{equation}
\Lean{M2\_gamma\_half, M1\_gamma\_integral}
...
\end{equation}
\Lean{selfdual\_gaussian\_unique, gaussian\_integral\_value}
...
\Lean{three\_halves\_unique, arity\_control\_three}
...
\Lean{spectral\_angle\_tan, spectral\_angle\_tower\_ratio}
\Lean{spectral\_surface\_closed}
...
\end{equation}
\tier{P}\Lean{M4\_sqrt2, M4\_sqrt3}
...
(App.~\ref{app:web}).
\Lean{modulus\_Omega, cocone\_property}
...
\end{equation}
\Lean{ricciCoeff, ricciScalar, einsteinCoeff}
...
$\chi(\mathbb{CP}^2)=3=n$ \Lean{hopf\_latitude, hopf\_from\_clifford}
The same arity-$3$ of
...
$H_5=\{0,1\}^5$, $|H_5|=2^{5}$ \Lean{hypercube\_card}
with
...
\Lean{worldline\_modulus\_is\_GN, hinge\_central\_charge}
