...
it supports are established in \S\ref{sec:dof}. \Lean{towerHam\_isHermitian, towerHam\_bounded\_below}
...
(App.~\ref{app:web}).\,\Lean{modulus\_Omega, cocone\_property}
...
generations---which remains structural. \Lean{colour\_ratio} The ultraviolet is regulated in two complementary
