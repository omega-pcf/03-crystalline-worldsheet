...
of \eqref{eq:isometry} enters cited~\cite{Maldacena98,GKP98,Witten98}.
\begin{figure}[!htbp]\centering
...
(Remark~\ref{rmk:spectral-origin}): \ProofWitness{bulk\_boundary\_isometry, spectral\_uniqueness, bulk\_boundary\_isometry}
