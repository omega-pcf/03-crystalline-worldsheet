...
\begin{equation}\label{eq:tower-modes}
  z(\sigma)=\golden^{\sigma},\qquad \Nmodes(\sigma)=\big\lfloor\pi\,\golden^{\sigma}\big\rfloor . \NumericalWitness{eq:tower-modes}
\end{equation}
...
it supports are established in \S\ref{sec:dof}. \ProofWitness{tower\_ham\_is\_hermitian, tower\_ham\_bounded\_below}
