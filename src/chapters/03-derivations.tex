...
\end{equation}
\LeanWrap{M2\_gamma\_half, M1\_gamma\_integral}
...
\end{equation}
\LeanWrap{selfdual\_gaussian\_unique, gaussian\_integral\_value}
...
\LeanWrap{three\_halves\_unique, arity\_control\_three}
...
\LeanWrap{spectral\_angle\_tan, spectral\_angle\_tower\_ratio}
\LeanWrap{spectral\_surface\_closed}
...
\end{equation}
\tier{P}\LeanWrap{M4\_sqrt2, M4\_sqrt3}
...
\end{equation}
\LeanFor{eq:tower-modes}{S\_tower}
...
(App.~\ref{app:web}).
\LeanWrap{modulus\_Omega, cocone\_property}
...
\end{equation}
\LeanWrap{ricciCoeff, ricciScalar, einsteinCoeff}
...
\LeanWrap{tower\_frobenius\_common}
...
\LeanWrap{worldline\_modulus\_is\_GN, hinge\_central\_charge}
