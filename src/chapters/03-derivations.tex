...
\LeanWrap{four\_cocone, conductor\_attribution}
...
$\chi(\mathbb{CP}^2)=3=n$ \LeanWrap{hopf\_latitude, hopf\_from\_clifford}
The same arity-$3$ of
...
$H_5=\{0,1\}^5$, $|H_5|=2^{5}$ \LeanWrap{hypercube\_card}
with
