...
complete and decidable precisely because it cannot internally define $\Vn$. Without G\"odel numbering no formula can
...
unifies---within a single lattice---the symmetries of $e^{i\pi}$, $\Vn$, $\E^3$, the primes,
...
\end{equation}
\Proof{lambda\_log, lambda\_log\_mul\_regulator, mersenne\_bridge}
