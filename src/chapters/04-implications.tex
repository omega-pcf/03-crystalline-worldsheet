...
$|\Om|_\sigma=\tfrac12$. \emph{Proof:} \ProofWitnessBlock{eisenstein\_cube, omega\_conj}; \cite{Witten01dS}.
...
\S\ref{app:embedding} (\ProofWitnessBlock{ds\_ricci\_from\_gauss}).
...
integer. \emph{Proof:} \ProofWitnessBlock{witten\_finite\_rank}; \eqref{eq:obs-spinstar}.
...
flow of the static patch at the Gibbons--Hawking temperature (\ProofWitnessBlock{tower\_scale\_group, tower\_flow\_fixes\_tau, omega\_flow\_group, omega\_flow\_invariant}).
...
\emph{Proof:} \ProofWitnessBlock{dS\_temperature, ds\_beta\_reciprocal} (\S\ref{app:embedding}) \cite{GibbonsHawking77}.
...
dimension count is \ProofWitnessBlock{ladder\_from\_scott, scott\_kissing\_eq\_two\_posroots, kissing\_eq\_two\_posroots, dims\_even\_ladder, ladder\_dim\_eq\_kissing\_plus\_rank, fks\_ladder\_dims}
...
(\S\ref{ssec:susy}). \ProofWitnessBlock{regge\_tower\_is\_euler\_product, regge\_dirichlet\_eq\_zeta} \NumericalWitness{prop:veneziano}
