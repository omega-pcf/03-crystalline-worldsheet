...
$S=\ln N$. \emph{Proof:}
\ProofBlock{witten\_entropy\_realized, witten\_finite\_rank, witten\_two\_conjectures} (by \texttt{rfl}---the most direct realisation).
The entropy
...
\ProofBlock{lambda\_magnitude\_eq\_level, sigma\_G\_val, sigma\_EM\_val, sigma\_Lambda\_val, threshold\_ordering, interval\_gap, interval\_gap\_general, em\_holographic\_fraction, em\_asymmetry, entropy\_at\_mu\_three, tower\_step\_ratio}
\end{remark}
