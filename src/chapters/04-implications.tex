...
$|\Om|_\sigma=\tfrac12$. \emph{Proof:} \LeanInline{eisenstein\_cube, omega\_conj}; \cite{Witten01dS}.
...
remains. \emph{Proof:}
\Lean{pairing\_FP\_modulus\_half, pairing\_PF\_modulus\_half}
...
\emph{Proof:}
\Lean{witten\_unitarity\_realized, density\_eigenvalues\_positive}
(4.7).
...
$S=\ln N$. \emph{Proof:}
\Lean{witten\_entropy\_realized} (by \texttt{rfl}---the most direct realisation),
\Lean{witten\_finite\_rank, witten\_two\_conjectures}.
The entropy
...
\Lean{omega\_flow\_invariant, tower\_scale\_group} \cite{CLPW22}.
...
\Lean{lattice\_radius\_conjugate}
...
\emph{Proof:} \Lean{dS\_temperature, dS\_beta\_reciprocal} (\S\ref{app:embedding}) \cite{GibbonsHawking77}.

\medskip
The formal statements underlying the accumulation and gravity movements follow; their
proofs are those of the corresponding \texttt{\textbackslash Lean} tags.
...
\Lean{tower\_first\_law, tower\_matter\_ingredients, S\_tower\_recurrence, binary\_entropy\_half}
...
$\sin^{2}\theta_W|_{\rm GUT}=\tfrac38=N(0)/N(2)$ \Lean{weinberg\_angle\_gut}
running to $0.231$ at
...
$V(\sigma)=\epsz\golden^{-\sigma}$\,\Lean{swampland\_hasDerivAt}
