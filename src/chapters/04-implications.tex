...
tower's own clock.
; the double copy~\cite{BCJ} (Bern--Carrasco--Johansson) \ProofWitness{fisher\_time\_lock, entropy\_response\_per\_bit, entropy\_response\_hasDerivAt}
...
the bridges of \S\ref{ssec:susy}.  (Kodama--Williams~\cite{KodamaWilliams}) \ProofWitness{positroid\_from\_kp, bridge\_cocycle} \NumericalWitness{TODO}
\end{proposition}
...
(the GKPW dictionary~\cite{GKP98,Witten98}) \ProofWitness{towerE\_eq\_exp\_regulator, S\_tower\_eq\_exp\_regulator}
%
