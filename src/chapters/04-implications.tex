...
\Lean{gauge\_dim\_su3, phi\_central\_chain, central\_chain, KK\_numerator, clifford\_S3\_condition, hopf\_from\_clifford, a2\_minimal\_vectors\_exactly\_six}.
...
\Lean{G\_Lambda\_duality}. The generations are not placed radially by this $\sigma$-assignment:
...
\Lean{Lambda5\_pcf, G\_Lambda\_duality}
\end{proposition}
\begin{proof}
