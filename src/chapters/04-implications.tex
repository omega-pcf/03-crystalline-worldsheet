...
tower's own clock.
; the double copy~\cite{BCJ} (Bern--Carrasco--Johansson) \ProofWitness{fisher\_time\_lock, entropy\_response\_per\_bit, entropy\_response\_has\_deriv\_at}
...
with the vacuum at $0$. \ProofWitness{tower\_ham\_is\_hermitian, casimir\_op\_is\_hermitian, tower\_ham\_bounded\_below, casimir\_op\_bounded\_below}
...
(the GKPW dictionary~\cite{GKP98,Witten98}) \ProofWitness{tower\_e\_eq\_exp\_regulator, S\_tower\_eq\_exp\_regulator}
%
...
theorem (Theorem~\ref{thm:funct-eq}, Theorem~\ref{thm:duality}). \ProofWitness{fixed\_line\_is\_face\_phi, functional\_equation\_fixed\_line, places\_assembly, s\_duality\_exact, s\_duality\_fixed\_point\_unique, theta\_from\_jacobi, functional\_equation\_fixed\_at\_half, places\_assembly, s\_duality\_exact}
