...
\ProofWitness{binary\_entropy\_half, S\_tower\_recurrence} \NumericalWitness{prop:entropy-max}
\end{proposition}
...
\ProofWitness{gap\_independent\_of\_cutoff, eps0\_Mpcf\_pi, Lambda\_QCD\_eq\_Lambda, Lambda\_QCD\_pos} \NumericalWitness{eq:transmutation}
\end{corollary}
