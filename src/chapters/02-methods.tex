...
the general congruence for every $q\neq2,5$ is Lucas' and enters as \HypWitness{}
\end{proposition}
...
(Poisson summation enters as \HypWitness{}) \ProofWitness{gammaR\_from\_tate}
%
...
evaluations enter as ) \HypWitness{}
\end{remark}
...
\begin{equation}\label{eq:hK}
  h_K=1 .
\end{equation}
(Minkowski's theorem enters as \HypWitness{}) \ProofWitness{minkowski\_bound\_lt\_two}
%
...
proved; the formula itself is the input.  (the class-number formula enters as \HypWitness{}) \ProofWitness{L1\_from\_class\_number\_formula, L1\_eq\_period\_over\_pi\_sqrt5}
%
\end{theorem}
...
rather than deferred.  (the global Dedekind factorisation enters as \HypWitness{}) \ProofWitness{odd\_zeta\_ratio}
...
the Polyakov action \eqref{eq:polyakov} (an \HypWitness{} input);
