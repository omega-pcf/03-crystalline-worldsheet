...
\ProofWitnessBlock{oplus\_formula}
\end{proposition}
...
(Poisson summation enters as \HypWitness{poisson\_summation}) \ProofWitness{gamma\_r\_from\_tate}
%
...
\begin{equation}\label{eq:hK}
  h_K=1 .
\end{equation}
(Minkowski's theorem~\cite{Minkowski1896}) \ProofWitness{minkowski\_bound\_lt\_two}
%
\ProofWitnessBlock{class\_number\_one\_K}%
\end{proposition}
...
proved; the formula itself is the input.  (the class-number formula enters as \HypWitness{class\_number\_formula})
...
rather than deferred.  (the global Dedekind factorisation enters as \HypWitness{dedekind\_factorisation}) \ProofWitness{odd\_zeta\_ratio}
