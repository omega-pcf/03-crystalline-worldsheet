...
\ProofBlock{degree\_formula\_K, ideal\_norm\_values\_K}
%
\ProofBlock{euler\_from\_ideals\_K}%
\ProofBlock{vonMangoldtK\_values}%
\ProofBlock{local\_dedekind\_ramified\_K, local\_dedekind\_split\_K, local\_dedekind\_inert\_K}%
\end{proposition}
