...
\ProofWitnessBlock{section2\_master, places\_assembly, fixed\_line\_is\_facePhi, functional\_equation\_fixed\_line, s\_duality\_exact, s\_duality\_fixed\_point\_unique, theta\_from\_jacobi}
\end{theorem}
