...
the present section consumes. \Lean{mersenne\_bridge}
...
$V^{\dagger}V=\mathbf1$. \Lean{bulkBoundary\_isometry}
\tier{P}
\end{lemma}
\begin{proof}
...
$\Re s=\mu$ (Theorem~\ref{thm:funct-eq}). \Lean{section2\_master, places\_assembly}
\tier{P}
\end{theorem}
