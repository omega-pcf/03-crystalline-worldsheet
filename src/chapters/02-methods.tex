...
\ProofWitness{M6\_phi\_root\_unique, M6\_characteristic\_root\_is\_phi} \NumericalWitness{eq:phisq}
\end{theorem}
...
(Theorem~\ref{thm:basel}). \ProofWitness{even\_zeta\_bernoulli} \NumericalWitness{thm:basel}
\end{theorem}
\begin{proof}
...
\ProofWitness{repulsion\_gives\_the\_modulus} \NumericalWitness{prop:repulsion-modulus}
\end{proposition}
