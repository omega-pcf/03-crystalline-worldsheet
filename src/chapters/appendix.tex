...
\Lean{G4\_eq\_omega\_sq}
The boundary Casimir $\tfrac34$ and the bulk Newton $\tfrac14$ sum to unity,
$\tfrac34+\tfrac14=1$ \Lean{casimir\_plus\_newton}
and the boundary density ratio is
...
bound \eqref{eq:kk-BF} because $\ln\golden<\tfrac12$ \Lean{log\_phi\_lt\_half}
Truncating to the
...
$R^{2}=\alpha'$\,\Lean{Tdual\_selfdual}
