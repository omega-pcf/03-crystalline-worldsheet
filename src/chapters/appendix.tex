...
de~Sitter embeds. \LeanWrap{ets\_constant\_block\_christoffels\_vanish}
...
$K_{\mu\nu}=(\lambda/\sigma^2)g_{\mu\nu}$. \LeanWrap{ets\_slices\_totally\_geodesic}
...
\eqref{eq:dim-chain}, \LeanWrap{central\_chain}.
...
\end{equation}
\LeanWrap{kk\_reduction, kk\_at\_PCF}
...
$\tfrac34+\tfrac14=1$ \LeanWrap{casimir\_plus\_newton}, and the boundary density ratio is
$\golden^{-2}-1=-\golden^{-1}$ \LeanWrap{boundary\_density\_ratio}.
...
bound \eqref{eq:kk-BF} because $\ln\golden<\tfrac12$ \LeanWrap{log\_phi\_lt\_half}. Truncating to the
...
$R^{2}=\alpha'$\,\LeanWrap{Tdual\_selfdual}, where the minimal vectors of the lattice supply the root
