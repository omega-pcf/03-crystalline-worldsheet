...
\NumericalWitness{eq:kk-rowsum, eq:kk-spectrum}
\end{remark}
...
the classical input.  (the rearrangement enters as \HypWitness{\cite{Hurwitz1891}}) \ProofWitness{hurwitz\_reindex}
...
$L(6,\chi_5)=\sqrt5\pi^{6}\cdot\tfrac{536}{1171875}$.  (Bernoulli enters as \HypWitness{standard result}) \ProofWitness{even\_L\_rationality, bernoulli\_eval\_rational}
...
(Gauss--Binet enters as \HypWitness{standard result}) \ProofWitness{kappaK\_two\_real\_places, kappaK\_alt, kappaK\_simple\_pole, kappaK\_pole\_numerator\_at\_one,
